...
elsei Text== "علام" or Text== "علام الهكر" then return  sendMsg(msg.chat_id_,msg.id_,"[اجمد من الجمدان ★](http://T.ME/M_A_L_L_A_M)")
elseif Text== "ندا" or Text== "بيست ماندو" then return  sendMsg(msg.chat_id_,msg.id_,"[بيست ماندو وبس  ♲](https://t.me/Nadaaaa7)")
