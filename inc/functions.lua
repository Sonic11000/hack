...
if redis:get(hack..'group:add'..msg.chat_id_) then  return '• **المجموعة تم تفعيلها مُسبقاً . ' end
...
if cmd == "dn_sudo" then
if not redis:sismember(hack..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'• **العضو » '..USERNAME..' \n• ** الايدي » (`'..UserID..'`)\n• **انه بالتأكيد ليس مطور \n') end
redis:srem(hack..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'• العضو » ❪ '..USERNAME..' ❫\n• الايدي » ❪ '..UserID..' ❫\n• تم تنزيله من المطور \n',17,USERCAR) 
end
...
.."\n• التعديل «» "..(redis:get(hack..'lock_edit'..msg.chat_id_) or 'false')
.."\n• الروابط «» "..(redis:get(hack..'lock_link'..msg.chat_id_) or 'false')
.."\n• التاك «» "..(redis:get(hack..'lock_tag'..msg.chat_id_) or 'false')
.."\n• المعرفات «» "..(redis:get(hack..'lock_username'..msg.chat_id_) or 'false')
.."\n• التكرار «» "..(redis:get(hack..'lock_flood'..msg.chat_id_) or 'false')
.."\n• الكلايش «» "..(redis:get(hack..'lock_spam'..msg.chat_id_) or 'false')
.."\n• الويب «» "..(redis:get(hack..'lock_webpage'..msg.chat_id_) or 'false')
.."\n• الماركدوان «» "..(redis:get(hack..'lock_markdown'..msg.chat_id_) or 'false')
.."\n• بالطرد البوتات «» "..(redis:get(hack..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n• البوتات «» "..(redis:get(hack..'lock_bots'..msg.chat_id_) or 'false')
.."\n• عدد التكرار «» "..(redis:get(hack..'num_msg_hack'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n•`اعدادات الوسائط :`\n"
.."\n*• *المتحركه «» "..(redis:get(hack..'mute_gif'..msg.chat_id_) or 'false')
.."\n• الدردشه «» "..(redis:get(hack..'mute_text'..msg.chat_id_) or 'false')
.."\n• الانلاين «» "..(redis:get(hack..'mute_inline'..msg.chat_id_) or 'false')
.."\n• الالعاب «» "..(redis:get(hack..'mute_game'..msg.chat_id_) or 'false')
.."\n• الصور «» "..(redis:get(hack..'mute_photo'..msg.chat_id_) or 'false')
.."\n• الفيديو «» "..(redis:get(hack..'mute_video'..msg.chat_id_) or 'false')
.."\n• البصمات «» "..(redis:get(hack..'mute_audio'..msg.chat_id_) or 'false')
.."\n• الصوت «» "..(redis:get(hack..'mute_voice'..msg.chat_id_) or 'false')
.."\n• الملصقات «» "..(redis:get(hack..'mute_sticker'..msg.chat_id_) or 'false')
.."\n• الجهات «» "..(redis:get(hack..'mute_contact'..msg.chat_id_) or 'false')
.."\n• التوجيه «» "..(redis:get(hack..'mute_forward'..msg.chat_id_) or 'false')
.."\n• الموقع «» "..(redis:get(hack..'mute_location'..msg.chat_id_) or 'false')
.."\n• الملفات «» "..(redis:get(hack..'mute_document'..msg.chat_id_) or 'false')
.."\n• الاشعارات «» "..(redis:get(hack..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n• الكيبورد «» "..(redis:get(hack..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*`اعدادات اخرى : `"
.."\n\n*•*الترحيب «» "..welcomex
.."\n*•*الردود «» "..replayx
...
.."\n*•*الويب «» "..(redis:get(hack..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*•*الماركدوان «» "..(redis:get(hack..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*•*البوتات بالطرد «» "..(redis:get(hack..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*•*البوتات «» "..(redis:get(hack..'lock_bots'..msg.chat_id_) or 'false')
.."\n*•*عدد التكرار «» "..(redis:get(hack..'num_msg_hack'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*•*اعدادات التقـييد :\n"
.."\n*•*التقييد بالتوجيه «» "..(redis:get(hack..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالصور «» "..(redis:get(hack..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالروابط «» "..(redis:get(hack..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*•*التقييد بالمتحركه «» "..(redis:get(hack..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*•*التقييد الفيديو «» "..(redis:get(hack..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
